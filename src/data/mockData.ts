...
export const produce: Produce[] = [
  ...
  { id: "p33", name: "Cumin Seeds", category: "Spices", farmerId: "f1", farmerName: "Rajesh Patel", farmerLocation: "Gujarat", price: 300, unit: "kg", availableQty: 700, minOrder: 10, grade: "A", harvestDate: "2025-11-25", image: "https://images.unsplash.com/photo-1607672632458-9eb56696346b?w=600&h=400&fit=crop", description: "Whole cumin seeds with strong earthy flavor. Gujarat's finest.", pricingTiers: [{ minQty: 10, price: 300 }, { minQty: 50, price: 280 }, { minQty: 100, price: 260 }] },
  ...
  { id: "p38", name: "Drumsticks (Moringa)", category: "Vegetables", farmerId: "f6", farmerName: "Lakshmi Reddy", farmerLocation: "Andhra Pradesh", price: 50, unit: "kg", availableQty: 2000, minOrder: 25, grade: "A", harvestDate: "2026-02-03", image: "https://images.unsplash.com/photo-1622205313162-be1d5712a43f?w=600&h=400&fit=crop", description: "Fresh moringa pods, tender and long. Packed with nutrients.", pricingTiers: [{ minQty: 25, price: 50 }, { minQty: 100, price: 45 }, { minQty: 300, price: 40 }] },
  ...
  { id: "p41", name: "Mustard Seeds", category: "Spices", farmerId: "f5", farmerName: "Deepak Yadav", farmerLocation: "Uttar Pradesh", price: 120, unit: "kg", availableQty: 2000, minOrder: 25, grade: "A", harvestDate: "2025-11-30", image: "https://images.unsplash.com/photo-1621510456681-2b5b26a62b28?w=600&h=400&fit=crop", description: "Black and yellow mustard seeds. Sharp flavor for pickles and cooking.", pricingTiers: [{ minQty: 25, price: 120 }, { minQty: 100, price: 110 }, { minQty: 500, price: 100 }] },
  ...
  { id: "p43", name: "Bitter Gourd", category: "Vegetables", farmerId: "f6", farmerName: "Lakshmi Reddy", farmerLocation: "Andhra Pradesh", price: 35, unit: "kg", availableQty: 1500, minOrder: 25, grade: "B", harvestDate: "2026-02-04", image: "https://images.unsplash.com/photo-1606585486091-d3eab47f4f0e?w=600&h=400&fit=crop", description: "Fresh karela, medium-sized and tender. Popular in Indian cuisine.", pricingTiers: [{ minQty: 25, price: 35 }, { minQty: 100, price: 31 }, { minQty: 300, price: 28 }] },
  ...
  { id: "p52", name: "Sapota (Chikoo)", category: "Fruits", farmerId: "f8", farmerName: "Kavitha Nair", farmerLocation: "Karnataka", price: 50, unit: "kg", availableQty: 2000, minOrder: 50, grade: "A", harvestDate: "2026-01-28", image: "https://images.unsplash.com/photo-1560155016-7be93b15b787?w=600&h=400&fit=crop", description: "Sweet, malty-flavored chikoo fruits. Uniform ripening.", pricingTiers: [{ minQty: 50, price: 50 }, { minQty: 200, price: 45 }, { minQty: 500, price: 40 }] },
];
