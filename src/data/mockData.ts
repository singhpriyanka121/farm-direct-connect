...
export const produce: Produce[] = [
  ...
  { id: "p12", name: "Fresh Cauliflower", category: "Vegetables", farmerId: "f2", farmerName: "Sunita Devi", farmerLocation: "Punjab", price: 35, unit: "kg", availableQty: 3000, minOrder: 50, grade: "A", harvestDate: "2026-01-28", image: "https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=600&h=400&fit=crop", description: "Tight, white cauliflower heads. Perfect for processing and retail.", pricingTiers: [{ minQty: 50, price: 35 }, { minQty: 200, price: 31 }, { minQty: 500, price: 28 }] },
  ...
  { id: "p24", name: "Fresh Ginger", category: "Vegetables", farmerId: "f4", farmerName: "Meena Sharma", farmerLocation: "Kerala", price: 80, unit: "kg", availableQty: 2000, minOrder: 25, grade: "A", harvestDate: "2026-01-15", image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=600&h=400&fit=crop", description: "Fresh, aromatic ginger roots. High oil content for food and beverages.", pricingTiers: [{ minQty: 25, price: 80 }, { minQty: 100, price: 72 }, { minQty: 500, price: 65 }] },
  ...
  { id: "p31", name: "Broccoli", category: "Vegetables", farmerId: "f2", farmerName: "Sunita Devi", farmerLocation: "Punjab", price: 60, unit: "kg", availableQty: 1200, minOrder: 25, grade: "A", harvestDate: "2026-02-06", image: "https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=600&h=400&fit=crop&q=80&auto=format", description: "Fresh organic broccoli with tight green florets. Rich in nutrients.", pricingTiers: [{ minQty: 25, price: 60 }, { minQty: 100, price: 55 }, { minQty: 300, price: 50 }] },
  ...
  { id: "p33", name: "Cumin Seeds", category: "Spices", farmerId: "f1", farmerName: "Rajesh Patel", farmerLocation: "Gujarat", price: 300, unit: "kg", availableQty: 700, minOrder: 10, grade: "A", harvestDate: "2025-11-25", image: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&h=400&fit=crop", description: "Whole cumin seeds with strong earthy flavor. Gujarat's finest.", pricingTiers: [{ minQty: 10, price: 300 }, { minQty: 50, price: 280 }, { minQty: 100, price: 260 }] },
  { id: "p34", name: "Curd (Yogurt)", category: "Dairy", farmerId: "f7", farmerName: "Harpreet Singh", farmerLocation: "Punjab", price: 50, unit: "kg", availableQty: 800, minOrder: 20, grade: "A", harvestDate: "2026-02-12", image: "https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=600&h=400&fit=crop", description: "Thick, creamy set curd made from full-fat A2 cow milk.", pricingTiers: [{ minQty: 20, price: 50 }, { minQty: 100, price: 45 }, { minQty: 300, price: 42 }] },
  ...
  { id: "p41", name: "Mustard Seeds", category: "Spices", farmerId: "f5", farmerName: "Deepak Yadav", farmerLocation: "Uttar Pradesh", price: 120, unit: "kg", availableQty: 2000, minOrder: 25, grade: "A", harvestDate: "2025-11-30", image: "https://images.unsplash.com/photo-1599909533601-aa042bfb1603?w=600&h=400&fit=crop", description: "Black and yellow mustard seeds. Sharp flavor for pickles and cooking.", pricingTiers: [{ minQty: 25, price: 120 }, { minQty: 100, price: 110 }, { minQty: 500, price: 100 }] },
  ...
  { id: "p43", name: "Bitter Gourd", category: "Vegetables", farmerId: "f6", farmerName: "Lakshmi Reddy", farmerLocation: "Andhra Pradesh", price: 35, unit: "kg", availableQty: 1500, minOrder: 25, grade: "B", harvestDate: "2026-02-04", image: "https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=600&h=400&fit=crop", description: "Fresh karela, medium-sized and tender. Popular in Indian cuisine.", pricingTiers: [{ minQty: 25, price: 35 }, { minQty: 100, price: 31 }, { minQty: 300, price: 28 }] },
  ...
  { id: "p45", name: "Urad Dal (Black Gram)", category: "Pulses", farmerId: "f1", farmerName: "Rajesh Patel", farmerLocation: "Gujarat", price: 100, unit: "kg", availableQty: 3000, minOrder: 100, grade: "A", harvestDate: "2025-12-10", image: "https://images.unsplash.com/photo-1585996754577-76d3f7e73e3c?w=600&h=400&fit=crop", description: "Premium split urad dal. Essential for dosa batter and dal makhani.", pricingTiers: [{ minQty: 100, price: 100 }, { minQty: 500, price: 94 }, { minQty: 1000, price: 88 }] },
  { id: "p46", name: "Pearl Millet (Bajra)", category: "Grains", farmerId: "f1", farmerName: "Rajesh Patel", farmerLocation: "Gujarat", price: 28, unit: "kg", availableQty: 7000, minOrder: 200, grade: "B", harvestDate: "2025-11-20", image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=600&h=400&fit=crop", description: "Nutritious bajra grains. High in iron and fiber. Perfect for flour.", pricingTiers: [{ minQty: 200, price: 28 }, { minQty: 1000, price: 25 }, { minQty: 3000, price: 22 }] },
  ...
  { id: "p50", name: "Sorghum (Jowar)", category: "Grains", farmerId: "f3", farmerName: "Arun Kumar", farmerLocation: "Maharashtra", price: 32, unit: "kg", availableQty: 6000, minOrder: 200, grade: "A", harvestDate: "2025-12-20", image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=600&h=400&fit=crop", description: "White sorghum grains for flour, porridge, and animal feed.", pricingTiers: [{ minQty: 200, price: 32 }, { minQty: 1000, price: 29 }, { minQty: 3000, price: 26 }] },
  { id: "p51", name: "Lady Finger (Okra)", category: "Vegetables", farmerId: "f5", farmerName: "Deepak Yadav", farmerLocation: "Uttar Pradesh", price: 38, unit: "kg", availableQty: 2500, minOrder: 50, grade: "A", harvestDate: "2026-02-06", image: "https://images.unsplash.com/photo-1425543103986-22abb7d7e8d2?w=600&h=400&fit=crop", description: "Tender, young okra pods. No fiber, perfect for cooking.", pricingTiers: [{ minQty: 50, price: 38 }, { minQty: 200, price: 34 }, { minQty: 500, price: 30 }] },
  { id: "p52", name: "Sapota (Chikoo)", category: "Fruits", farmerId: "f8", farmerName: "Kavitha Nair", farmerLocation: "Karnataka", price: 50, unit: "kg", availableQty: 2000, minOrder: 50, grade: "A", harvestDate: "2026-01-28", image: "https://images.unsplash.com/photo-1619566636858-adf3ef46400b?w=600&h=400&fit=crop", description: "Sweet, malty-flavored chikoo fruits. Uniform ripening.", pricingTiers: [{ minQty: 50, price: 50 }, { minQty: 200, price: 45 }, { minQty: 500, price: 40 }] },
];
