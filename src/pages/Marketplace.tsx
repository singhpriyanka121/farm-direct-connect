        ...
        <div className="flex flex-col md:flex-row gap-3 mb-8">
          <div className="relative flex-1">
            <Input
              ...
              className="rounded-full text-center pl-4 pr-10"
            />
            <Search className="absolute right-1/2 translate-x-1/2 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground pointer-events-none peer-focus:hidden" style={{ display: search ? 'none' : undefined }} />
          </div>
